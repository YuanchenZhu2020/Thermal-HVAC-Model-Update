...
if __name__ == "__main__":
    ...
    if mode == "train":
        ...
        for lr in learning_rate:
            ...
            model.save(str(CKPT_PATH / "AC_A2C_rwd_offset.zip"))
        ...
        # 加载训练好的模型
        model = A2C.load(str(CKPT_PATH / "AC_A2C_rwd_offset.zip"))
        ...
        # 绘制温度变化曲线
        plt.plot(T_seq, T_in_rl, "r--", label="RL_A2C")
